"""
Scraper for JEN (Juelicher Entsorgungsgesellschaft fuer Nuklearanlagen).

URL: https://www.jen-juelich.de/ausschreibungen/aktuelle-ausschreibungen
Nuclear decommissioning tenders from JEN, Germany.
"""
...
@register_scraper
class JENScraper(BaseScraper):
    """Scraper for JEN Juelich tenders portal."""

    PORTAL_NAME = "jen"
    PORTAL_URL = "https://www.jen-juelich.de/ausschreibungen/aktuelle-ausschreibungen"
    REQUIRES_SELENIUM = True

    def scrape(self) -> List[TenderResult]:
        """
        Execute scraping logic for JEN portal.
        ...
        try:
            ...
            self.logger.error(f"JEN scraping failed: {e}")
    ...
    def _parse_results(self, soup: BeautifulSoup) -> List[TenderResult]:
        ...
        # Strategy 1: Look for announcements table (from old notebook)
            ...
            try:
                ...
                if titel:
                    results.append(TenderResult(
                        ...
                        link=link,
                        titel=titel,
                        ausschreibungsstelle="JEN",
                        ausfuehrungsort="Juelich",
    ...
    def _parse_tender_item(self, item, now: datetime) -> TenderResult:
        ...
        try:
            ...
            self.logger.warning(f"Failed to parse JEN item: {e}")
            return None
